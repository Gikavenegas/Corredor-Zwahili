...
$updateCat = "UPDATE cat_productos SET idCodigo_Cat='$codCat', Nombre_Categoría='$nomCat', AnchoRollo='$anRollo', RindeRollo='$rindRollo' WHERE idCodigo_Cat ='$id'";

$insert=mysqli_query($conexion, $updateCat);
