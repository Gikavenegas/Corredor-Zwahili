        ...
        <div class="container">
            <div class="row">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="administrador.php">Index</a>
                    </li>
                    <li class="nav-item">
            ...
            <form action="provSetBD.php" method="POST">
                <div class="row">
                ...
                <div class="row g-3">
                    <div class="col">
                        <input type="text" class="form-control" aria-label="First name" name="DNI">
                    </div>
                    <div class="col">
                        <input type="text" class="form-control" aria-label="Last name" name="Nombre">
                    </div>
                    <div class="col">
                        <input type="text" class="form-control" aria-label="First name" name="Apellido">
                    </div>
                    <div class="col">
                        <input type="text" class="form-control" aria-label="First name" name="Teléfono">
                    </div>
                    <div class="col">
                        <input type="text" class="form-control" aria-label="First name" name="Dirección">
                    </div>
            ...
            <h4>Listado completo de proveedores</h4>
                ...
                <table class="table table-responsive">  
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="provEditBD.php?id=<?php echo $tabla['DNI'];?>"><i class="fas fa-pencil-alt"></i></a></td>                        
                            <td><a href="provDeleBD.php?id=<?php echo $tabla['DNI'];?>"><i class="fas fa-trash-alt"></i></a></td>   
                        </tr>
                    <?php } 
                    ?>
                </table>        
